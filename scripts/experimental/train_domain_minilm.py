"""Train the isolated restaurant-domain-adapted compact encoder experiment."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Domain-adapt and fine-tune BERT-Mini for restaurant ABSA."
    )
    parser.add_argument(
        "--data-dir",
        type=Path,
    ...
    save_artifact(model, tokenizer, metrics, args.output_dir)
    print(
        json.dumps(
            {
